...
function App({ cname, pname, theme }: Props) {
    ...
    const onIntersection = (entries: any) => {
        ...
        if (firstEntry.isIntersecting && hasmore) {
            ...
            let newArr = postsarr.filter((p) => p.author == pname);
            setHasmore(() => false);
                ...
                return (
                    <Card className={`max-w-[340px] ${cname}`} key={idx}>
                        ...
                        >
                            ...
                            <div className="flex gap-3 upvotebtnpe">
                                <Button
                                    size="sm"
                                    radius="sm"
                                    color="default"
                        ...
                        <CardBody className="px-3 py-0 text-small text-default-400">
                            ...
                            >
                                <div className="flex flex-row gap-3">
                                    <p className="text-xl postheadingpe">
                                        {obj.title}
                                    </p>
                                    <Chip
                                        className="text-default-400 font-semibold flairpostpe"
                                        variant="shadow"
                                        style={{
                        ...
                        <CardFooter className="gap-3 postfooterpe">
                            <div className="flex gap-3 postfootpe items-center justify-center mt-3">
