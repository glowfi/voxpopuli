...
function App({ cname, gname, theme, pid }: Props) {
    ...
    const onIntersection = (entries: any) => {
        ...
        if (firstEntry.isIntersecting && hasmore) {
            ...
            let tmpArr = postsarr.filter((p) => p.subreddit == gname);
            let newArr = tmpArr.filter((p) => p.id == pid);
            setHasmore(() => false);
                ...
                return (
                    <Card className={`max-w-[340px] ${cname}`} key={idx}>
                        ...
                        >
                            ...
                            <div className="flex gap-3 upvotebtnpo">
                                <Button
                                    size="sm"
                                    radius="sm"
                                    color="default"
                        ...
                        <CardBody className="px-3 py-0 text-small text-default-400">
                            ...
                            >
                                <div className="flex flex-row gap-3">
                                    <p className="text-xl postheadingpo">
                                        {obj.title}
                                    </p>
                                    <Chip
                                        className="text-default-400 font-semibold flairpostpo"
                                        variant="shadow"
                                        style={{
                                ...
                                obj.src.includes('.jpeg') ? (
                                    ...
                                    <p className="postfootertxtpo">
                                        {obj.src.slice(25)} ...
                                    </p>
                                )}
                            </div>
                        </CardBody>
                        <CardFooter className="gap-3 postfooterpo">
                            <div className="flex gap-3 postfootpo items-center justify-center mt-3">
                            ...
                            <div className="flex gap-3 postfootpo items-center justify-center">
                                <p className="font-semibold text-default-400 text-small">
                                    <FaAward size={'1.3rem'} />
                                </p>
                                <Link
                            ...
                            <div
                                className="flex gap-3 postfootpo items-center justify-center"
                                onClick={(e) => {
                                    e.preventDefault();
